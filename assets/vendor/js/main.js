...
//            if ($(".swiper-demo-header-style").length > 0) swiperDemoHeaderStyle.onResize();
    ...
    var $Worksdiv = '<div class="all-works alt-font sm-display-none popup-with-zoom-anim wow fadeInUp"><a href="/works"><i class="ti-harddrives"></i><span>Works</span></a></div>';
